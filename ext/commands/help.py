...
class HelpCommand:
    ...
    def __init__(self, **options) -> None:
        ...
        self.context: Context = wolfcord.utils.MISSING
    ...
    def get_max_size(self, commands):
        ...
        as_lengths = (wolfcord.utils.string_width(c.name) for c in commands)
        return max(as_lengths, default=0)

    def get_destination(self):
        """Returns the :class:`~wolfcord.abc.Messageable` where the help command will be output.
    ...
    async def command_callback(self, ctx, *, command=None):
        ...
        maybe_coro = wolfcord.utils.maybe_coroutine
...
class DefaultHelpCommand(HelpCommand):
    ...
    def add_indented_commands(self, commands, *, heading, max_size=None) -> None:
        ...
        get_width = wolfcord.utils.string_width
